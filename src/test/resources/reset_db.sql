...
INSERT INTO contract (id, name, description, priceForTime, timePeriodHours, author) VALUES (1, 'no contract', 'default contract is no contract', 0, 0, 4), (2, 'free contract', 'free contract is free', 0, 0, 4), (3, '$10 contract', '$10 contract is $10/year', 10, 8766, 4);
INSERT INTO subscription (id, start, end, subscriber, directoryId, contractId) VALUES (1, NOW(), NOW(), 5, 2, 2);
INSERT INTO youTubeVideo (youTubeId, title, duration, metadata) VALUES ('', '', -1, '-'), ('', '', -1, '-'), ('', '', -1, '-'), ('', '', -1, '-'), ('', '', -1, '-');