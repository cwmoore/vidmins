...
INSERT INTO video (id, youTubeId, addDate, title, duration, directoryId) VALUES (2,'4HzWKwExaeo','2019-01-28 10:26:38','Week1Act5',-1,1),(3,'dF0NWtxRXsg','2019-01-28 16:31:59','PHP Week 1',3842,1),(4,'4KGGkytxlZM','2019-01-29 16:17:37','Welcome',-1,2);
...
INSERT INTO contract (id, name, description, priceForTimePeriod, timePeriodHours, author) VALUES (1, 'no contract', 'default contract is no contract', 0, 0, 4), (2, 'free contract', 'free contract is free', 0, 0, 4), (3, '$10 contract', '$10 contract is $10/year', 10, 8766, 4);
INSERT INTO subscription (id, name, description, start, end, subscriberId, directoryId, contractId) VALUES (1, 'subscription 1', 'subscription description 1', NOW(), NOW(), 1, 2, 2), (2, 'subscription 2', 'subscription description 2', NOW(), NOW(), 2, 1, 1);
INSERT INTO youTubeVideo (youTubeId, title, duration, metadata) VALUES ('4HzWKwExaeo', 'Week 1 Act 5', -1, '-'), ('dF0NWtxRXsg', 'PHPWk1', -1, '-'), ('4KGGkytxlZM', 'Welcome video', -1, '-');